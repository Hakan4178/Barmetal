...
#define VMCB_CLEAN_STABLE  (VMCB_CLEAN_INTERCEPTS | VMCB_CLEAN_IOPM | \
                            VMCB_CLEAN_MSRPM | VMCB_CLEAN_NP |        \
                            VMCB_CLEAN_CRX | VMCB_CLEAN_DRX |         \
                            VMCB_CLEAN_DT | VMCB_CLEAN_SEG |          \
                            VMCB_CLEAN_CR2 | VMCB_CLEAN_LBR)
